export const Descriptions = {
    AIRBNB: [
        "Over the summer of 2019, I interned on the Trip Platform, Search Intelligence team at Airbnb in San Francisco. During my time there I worked on developing a service using Java and Airflow aimed at serving medium-sized datasets in-memory to any subscribing services. The datasets would be versioned, allowing them to be dynamically created, updated, or reverted with ease. The most interesting part of the project for me was solving how to handle notifying subscribing services when there changes were made, asynchronously downloading the underlying data, and atomically swapping the two references, all while trying to minimize downtime."
    ],
    CAPITAL_ONE: [
